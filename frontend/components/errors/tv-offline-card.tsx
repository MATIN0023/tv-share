...
type TvOfflineCardProps = {
  /** Text shown on the TV screen (default matches the original design). */
  screenText?: string;
};

/** Retro TV offline / no-network illustration — Stefan Devai inspired (Dribbble). */
export function TvOfflineCard({
  screenText = "Check Your Network :(",
}: TvOfflineCardProps) {
  return (
    <StyledWrapper>
